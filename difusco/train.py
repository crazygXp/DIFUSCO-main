...
def arg_parser():
  ...
  parser.add_argument('--training_split', type=str, default='data/tsp/tsp50_train_concorde.txt') # 训练集
  ...
  parser.add_argument('--validation_split', type=str, default='data/tsp/tsp50_test_concorde.txt') # 验证集
  parser.add_argument('--test_split', type=str, default='data/tsp/tsp50_test_concorde.txt') # 测试集
